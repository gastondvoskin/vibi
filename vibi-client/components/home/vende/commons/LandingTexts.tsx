...
export const SubTitle: React.FC<Props> = ({ text, showColor, size }) => {
  return <p className={showColor ? (`font-bold ${size != undefined ? size : 'text-5xl'} text-vibiDarkBlue pb-0.5`) : (`text-primary font-bold ${size != undefined ? size : 'text-5xl'} pb-0.5`)}>{text}</p>;
};
