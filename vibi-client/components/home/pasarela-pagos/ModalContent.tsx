...
import { FText } from '../vende/commons/LandingTexts';
  ...
  console.log("Lleguie a modalcontent");
    ...
    <div className="w-fit h-[485px] p-10 border-2">
      <div className=" bg-white z-50 border-2">
        ...
        <FText text={content} color='font-bold text-2xl text-vibiDarkBlue pb-2'/>
        <FText text='Vende tu propiedad y destaca con los mejores ángulos y las fotografías adecuadas para demostrar su verdadero potencial, permítanos hacer que tu hogar luzca genial.' color='text-sm font-normal text-vibiDarkBlue'/>
        </section>
        <section className='flex'>
            <FText text='También te podría interesar:' color='text-base font-semibold text-vibiDarkBlue '/>
