import ButtonVariants from "../../../components/commons/ButtonVariants"
    ...
    return (
        <div className="max-w-[552px] mx-auto ">
            <div className="flex flex-col gap-8 items-center bg-white w-full border border-slate-300  rounded-xl py-12">
                <div className="">
                    <h1 className="text-[24px] font-semibold">¡Bienvenido a Vibi!</h1>
                    <p className="text-lg">Vamos a crear una cuenta para ti.</p>
                </div>
